...
```{r chunkname, class="figure", echo=FALSE, results="hide", fig.retina=2, out.width="100", alt="Label. alternative text please make it informative", caption="this is what this image shows, write it here or in the paragraph after the image as you prefer"}
plot(1:10)
```
