...
```{r rotate-and-strech, echo=TRUE, class="figure", caption="A vector transformed by rotation (left) and stretching (right)", alt="vectors and transformed vectors"}
...
```{r echo=TRUE, eval=FALSE, hlopts=list(linenos="table", linenostart=40)}
vec_stack_trans <- t(apply(vec_stack, MARGIN = 1, FUN = `%*%`, t(mat_trans)))
```
