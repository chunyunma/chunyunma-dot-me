...
transform <- function(matrix, mat = "a", l1, l2, l3, l4, r1, r2, r3, r4) {
  ...
  ylim <- c(-4, 4)
  plot(xlim, ylim,
    type = "n", xlab = "x", ylab = "y", main = "original vectors", asp = 1
  )
  abline(v = 0, h = 0, col = "gray")
  grid()
  # draw the circle
  lines(x = vec_stack[, 1], y = vec_stack[, 2], col = "#0072B2", lwd = 2)
  ...
  plot(xlim, ylim,
    type = "n", xlab = "x", ylab = "y", main = "New vectors after transformation", asp = 1
  )
  abline(v = 0, h = 0, col = "gray")
  grid()
  lines(
  ...
  text(1, 2.7,
    ...
    # # I could not get bold() and bquote() work together
    # dplyr::case_when(mat == "a" ~ expression(bold(Ax)),
    #   mat == "b" ~ expression(bold(Bx)),
    #   mat == "c" ~ expression(bold(Cx))
    #   ),
    col = "#56B4E9",
    cex = 2)
...
```{r eigenvectors, class="figure", caption="Eigenvectors (left) and transformed eigenvectors (right).", alt="eigenvectorsa. Eigenvectors (left) and transformed eigenvectors (right)."}
transform(matrix = mat_a,
  mat = "A",
  1.5, 0,
  -0.4, 0.5,
  2, -0.4,
...
```{r eigenvectors-matrix-b, class="figure", caption="Eigenvectors (left) and transformed eigenvectors (right) for matrix B.", alt="eigenvectorsb. Eigenvectors (left) and transformed eigenvectors (right) for matrix B."}
# target matrix
mat_b <- matrix(c(3, 1, 1, 2), 2)
transform(matrix = mat_b,
  mat = "B",
  0.6, -1.3,
  -1.2, -0.7,
  1.2, -2,
...
```{r eigenvectors-matrix-c, class="figure", caption="Eigenvectors (left) and transformed eigenvectors (right) for matrix C", alt="eigenvectorsc. Eigenvectors (left) and transformed eigenvectors (right) for matrix B."}
# target matrix
mat_c <- matrix(c(3, 1, 1, 0.8), 2)
transform(matrix = mat_c,
  mat = "C",
  0.6, -1.3,
  -1.2, -0.7,
  1.2, -0.7,
